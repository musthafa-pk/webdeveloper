              ...
              <nav className="navbar navbar-expand-lg navbar-light " style={{backgroundColor:data.color}}>
                <div className="container-fluid">
                  <div className="col-md-3">
                    {data.brandname ?  <div id="logo"><a href="#"><span style={{color:data.textcolor1}}>{data.brandname}</span></a></div> : <div id="logo"><a href="#"> <span style={{color:data.textcolor1}}>Chaavie Solutions</span> </a></div>}
                  </div>
