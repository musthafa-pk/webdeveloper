  ...
  return (
    <div>
      ...
      <div className="container">
        ...
        {props.data.pagetext3 ? <p>{props.data.pagetext3}</p> : <p class="text-center w-responsive mx-auto mb-5">Do you have any questions? Please do not hesitate to contact us directly. Our team will come back to you within
